package org.example.realprojectexam.config;

import lombok.RequiredArgsConstructor;
import org.example.realprojectexam.security.CustomOauth2AthenticationSuccessHandler;
import org.example.realprojectexam.security.CustomUserDetailsService;
import org.example.realprojectexam.service.SocialUserService;
...
public class SecurityConfig {
    ...
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http, CustomOauth2AthenticationSuccessHandler customOauth2AthenticationSuccessHandler) throws Exception{
        http
                .authorizeRequests(authorize -> authorize
                        .requestMatchers("/userregform","/userreg","/","/loginform").permitAll() //아무런 권한이 없어도 접근 가능할 페이지
